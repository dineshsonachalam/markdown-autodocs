...
export const generateArtifactsTable = function(content, options = {}, config) {
    ...
    artifactsTable = artifactsTable.concat('<br><p>Auto generated by <a href="https://github.com/dineshsonachalam/markdown-autodocs-test">markdown-autodocs-test</a></p>')
...
export const app = async function(outputFilePath, category, repo, branch, githubApiToken) {
    ...
    if(category == "code-block"){
        ...
        markdownMagic(markdownPath, config)
        return `Autodocumented ${workflowInfo.totalArtifacts} artifacts in artifactsTable - ${outputFilePath}`
    }
}
